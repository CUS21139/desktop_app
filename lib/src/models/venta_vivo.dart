...
class VentaVivo extends Venta {
  ...
  factory VentaVivo.fromJson(Map<String, dynamic> jsonData) => VentaVivo(
        id: jsonData['id'],
  ...
  VentaVivo insertarPesajeDescuento(Pesaje pesaje) {
    pesajes.add(pesaje);
  ...
  VentaVivo editarPrecio(double newPrecio) {
