...
class FiltrosVentasBeneficiado extends StatefulWidget {
  const FiltrosVentasBeneficiado({super.key});

  @override
  State<FiltrosVentasBeneficiado> createState() => _FiltrosVentasBeneficiadoState();
}

class _FiltrosVentasBeneficiadoState extends State<FiltrosVentasBeneficiado> {
  final filtroServ = FiltroBeneficiadoService();
  final ventaService = VentasBeneficiadoService();
  ...
  Future<void> buscarID(int id) async {
    ...
    CustomDialog.loadingDialog(context);
    await ventaService.getVenta(id, token).then((value) {
  ...
  Future<void> verAnuladas() async {
    ...
    CustomDialog.loadingDialog(context);
    await ventaService.getVentas(token, ini, fin).then((value) {
      ventaProv.setVentas(value, true);
      ventaProv.ventaInitState();
      Navigator.pop(context);
    }).catchError((e) {
