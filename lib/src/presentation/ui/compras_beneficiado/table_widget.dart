...
class TableComprasBeneficiado extends StatefulWidget {
  const TableComprasBeneficiado({super.key, required this.height});
  final double height;

  @override
  State<TableComprasBeneficiado> createState() => _TableComprasBeneficiadoState();
}

class _TableComprasBeneficiadoState extends State<TableComprasBeneficiado> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        SizedBox(
          width: globalWidth,
          child: Consumer<ComprasBeneficiadoProv>(builder: (_, service, __) {
            return Flex(
      ...
      builder: (c) => ContentDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            SizedBox(
              width: 400,
              child: Consumer<ProductosBeneficiadoProv>(
