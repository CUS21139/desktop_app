...
class FiltrosComprasVivos extends StatefulWidget {
  const FiltrosComprasVivos({super.key});

  @override
  State<FiltrosComprasVivos> createState() => _FiltrosComprasVivosState();
}

class _FiltrosComprasVivosState extends State<FiltrosComprasVivos> {
