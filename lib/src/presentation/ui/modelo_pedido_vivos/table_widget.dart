...
class TableOrdenesModeloVivo extends StatefulWidget {
  const TableOrdenesModeloVivo({super.key, required this.height});
  final double height;

  @override
  State<TableOrdenesModeloVivo> createState() => _TableOrdenesModeloVivoState();
}

class _TableOrdenesModeloVivoState extends State<TableOrdenesModeloVivo> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        SizedBox(
          width: globalWidth,
          child: Consumer<OrdenesModeloVivoProv>(builder: (_, service, __) {
            return Flex(
  ...
  void update(BuildContext context) {
    final token = Provider.of<UsuariosProv>(context, listen: false).token;
    final ordenesProv = Provider.of<OrdenesModeloVivoProv>(context, listen: false);
