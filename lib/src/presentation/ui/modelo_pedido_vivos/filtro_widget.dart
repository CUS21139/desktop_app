...
class FiltrosModeloProgramacionVivo extends StatefulWidget {
  const FiltrosModeloProgramacionVivo({super.key});

  @override
  State<FiltrosModeloProgramacionVivo> createState() => _FiltrosModeloProgramacionVivoState();
}

class _FiltrosModeloProgramacionVivoState extends State<FiltrosModeloProgramacionVivo> {
