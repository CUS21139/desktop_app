...
class CreateCompraVivos extends StatefulWidget {
  const CreateCompraVivos({super.key});

  @override
  State<CreateCompraVivos> createState() => _CreateCompraVivosState();
}

class _CreateCompraVivosState extends State<CreateCompraVivos> {
