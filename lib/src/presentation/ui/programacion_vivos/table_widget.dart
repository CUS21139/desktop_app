...
class TableOrdenesVivo extends StatefulWidget {
  const TableOrdenesVivo({super.key, required this.height});
  final double height;

  @override
  State<TableOrdenesVivo> createState() => _TableOrdenesVivoState();
}

class _TableOrdenesVivoState extends State<TableOrdenesVivo> {
            ...
            child: ScrollConfiguration(
              ...
              child: Consumer<OrdenesVivoProv>(builder: (_, service, __) {
                ...
                return HorizontalDataTable(
                  ...
                  rightHandSideColumnWidth: globalWidth - 50,
                  rightSideItemBuilder: (c, i) {
                    ...
                    return GestureDetector(
                      onTap: orden.delivered == 1
                          ? null
                          : () {
                              OrdenVivo.fromJson(orden.toJson());
  ...
  void autogen() async {
    ...
    final ordenesProv = Provider.of<OrdenesVivoProv>(context, listen: false);
    final ordenesModeloProv =
        Provider.of<OrdenesModeloVivoProv>(context, listen: false);

    final productos =
        Provider.of<ProductosVivoProv>(context, listen: false).productos;
  ...
  void confirmarOrden(BuildContext context, OrdenVivo orden) async {
    final token = Provider.of<UsuariosProv>(context, listen: false).token;
    final ordenProv = Provider.of<OrdenesVivoProv>(context, listen: false);
    final fechaProv = Provider.of<AyerHoyProv>(context, listen: false);
