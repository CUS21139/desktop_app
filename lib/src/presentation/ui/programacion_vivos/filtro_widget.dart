...
class FiltrosProgramacionVivo extends StatefulWidget {
  const FiltrosProgramacionVivo({super.key});

  @override
  State<FiltrosProgramacionVivo> createState() => _FiltrosProgramacionVivoState();
}

class _FiltrosProgramacionVivoState extends State<FiltrosProgramacionVivo> {
  ...
  Future<void> verConfirmadas() async {
    ...
    await OrdenesVivoService().getOrdenes(token, ini, fin).then((value) {
...
//   final ordenes = Provider.of<OrdenesVivoProv>(context, listen: false)
//       .ordenes
