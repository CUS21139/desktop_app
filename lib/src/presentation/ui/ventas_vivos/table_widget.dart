...
class TableVentasVivo extends StatefulWidget {
  const TableVentasVivo({super.key, required this.height});
  final double height;

  @override
  State<TableVentasVivo> createState() => _TableVentasVivoState();
}

class _TableVentasVivoState extends State<TableVentasVivo> {
            ...
            return Flex(
              ...
              children: [
                ...
                ExcelButton(
                  onPressed: () async {
                    await ExcelService()
                        .exportarReporteDelDia(lista: service.ventas);
                  },
                ),
                const Spacer(),
